...
import com.cabbietransport.pilot.base.BaseFragment;
...
import com.cabbietransport.pilot.ui.activity.upcoming_detail.UpcomingTripDetailActivity;
import com.cabbietransport.pilot.ui.adapter.UpcomingTripAdapter;
import com.cabbietransport.pilot.ui.bottomsheetdialog.cancel.CancelDialogFragment;
...
public class UpcomingTripFragment extends BaseFragment implements UpcomingTripIView,
    ...
    public void cancelRide(HistoryList historyList, int pos) {
        ...
        DATUM_history = historyList;
        SharedHelper.putKey(getContext(), AppConstant.SharedPref.CANCEL_ID, String.valueOf(DATUM_history.getId()));
