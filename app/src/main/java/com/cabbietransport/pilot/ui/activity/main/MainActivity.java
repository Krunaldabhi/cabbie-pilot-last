...
import com.cabbietransport.pilot.common.ChatHeadService;
import com.cabbietransport.pilot.common.GPSTracker;
import com.cabbietransport.pilot.common.LocaleHelper;
import com.cabbietransport.pilot.common.PolyUtil;
import com.cabbietransport.pilot.common.SharedHelper;
import com.cabbietransport.pilot.common.Utilities;
import com.cabbietransport.pilot.common.chat.ChatActivity;
import com.cabbietransport.pilot.common.fcm.MyFireBaseMessagingService;
import com.cabbietransport.pilot.common.swipe_button.SwipeButton;
import com.cabbietransport.pilot.data.network.model.LatLngFireBaseDB;
...
import com.cabbietransport.pilot.ui.activity.account_approval.ApprovalActivity;
import com.cabbietransport.pilot.ui.activity.document.DocumentActivity;
import com.cabbietransport.pilot.ui.activity.earnings.EarningsActivity;
import com.cabbietransport.pilot.ui.activity.instant_ride.InstantRideActivity;
import com.cabbietransport.pilot.ui.activity.invite.InviteActivity;
import com.cabbietransport.pilot.ui.activity.invite_friend.InviteFriendActivity;
import com.cabbietransport.pilot.ui.activity.notification_manager.NotificationManagerActivity;
import com.cabbietransport.pilot.ui.activity.profile.ProfileActivity;
import com.cabbietransport.pilot.ui.activity.setting.SettingsActivity;
import com.cabbietransport.pilot.ui.activity.summary.SummaryActivity;
import com.cabbietransport.pilot.ui.activity.wallet.WalletActivity;
import com.cabbietransport.pilot.ui.activity.your_trips.YourTripActivity;
import com.cabbietransport.pilot.ui.bottomsheetdialog.invoice_flow.InvoiceDialogFragment;
import com.cabbietransport.pilot.ui.bottomsheetdialog.rating.RatingDialogFragment;
import com.cabbietransport.pilot.ui.fragment.incoming_request.IncomingRequestFragment;
import com.cabbietransport.pilot.ui.fragment.offline.OfflineFragment;
import com.cabbietransport.pilot.ui.fragment.status_flow.StatusFlowFragment;
...
import com.cabbietransport.pilot.MvpApplication;
import com.cabbietransport.pilot.R;
import com.cabbietransport.pilot.ui.activity.card.CardActivity;
import com.cabbietransport.pilot.ui.activity.help.HelpActivity;
...
import static com.cabbietransport.pilot.MvpApplication.DATUM;
import static com.cabbietransport.pilot.MvpApplication.DEFAULT_ZOOM;
import static com.cabbietransport.pilot.MvpApplication.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.cabbietransport.pilot.MvpApplication.canGoToChatScreen;
import static com.cabbietransport.pilot.MvpApplication.isChatScreenOpen;
import static com.cabbietransport.pilot.MvpApplication.mLastKnownLocation;
            ...
            r = () -> {
                if (mLastKnownLocation != null) {
                    ...
                    presenter.getTrip(params);
                        ...
                        || DATUM.getStatus().equals(AppConstant.checkStatus.PICKEDUP)) if (canMapAnimate % 3 == 0) {
