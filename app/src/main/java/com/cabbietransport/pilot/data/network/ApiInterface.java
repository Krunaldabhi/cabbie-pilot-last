package com.cabbietransport.pilot.data.network;
...
//    Observable<Object> sendFcm(@Body JsonObject jsonObject);
    ...
    @FormUrlEncoded
    @POST("api/provider/send/approval/reminder")
    Observable<ReminderMessage> sendReminderMessage(@FieldMap HashMap<String, Object> params);


    @POST("api/provider/get-fleet-owners")
    Observable<List<LimoOwnerResponse>> getLimoOwners();
}
